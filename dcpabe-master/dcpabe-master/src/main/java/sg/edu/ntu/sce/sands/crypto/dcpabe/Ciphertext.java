...
public class Ciphertext implements Serializable {
    ...
    public String toString() {
        ...
        sb.append("c0=").append(Arrays.toString(c0)).append(", ");
        sb.append("c1=").append(Arrays.deepToString(c1.toArray())).append(", ");
        sb.append("c2=").append(Arrays.deepToString(c2.toArray())).append(", ");
        sb.append("c3=").append(Arrays.deepToString(c3.toArray())).append(", ");
        sb.append("accessStructure=").append(accessStructure.toString());
        sb.append("}");
        return sb.toString();
    }
}
